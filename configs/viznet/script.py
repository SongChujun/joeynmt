                        ...
                        for hs_enc in features['hidden_size_enc']:
                            for hs_dec in features['hidden_size_dec']:
                                for bs in features['batch_size']:
                                    ...
                                    with open(f"/Users/calvinbao/Documents/src/spring2020/cmsc828b/joey/configs/viznet/attempt3/{num_head_enc}_{num_head_dec}_{dropout}_{hs_enc}_{hs_dec}_{bs}_{enc_layer}_{dec_layer}.yml", 'w') as outfile:
